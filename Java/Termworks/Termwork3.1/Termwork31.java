...
class Termwork31
{
	...
	{
		mybankAccount p1 = new mybankAccount(1,"SB","Yash","C.T.S 10919 1st Main 2nd cross, Sadashiv nagar",5000);
		p1.displayDetails();
		p1.interest(5);
		...
		mybankAccount p3 = new mybankAccount(1,"FD","Mulla","C.T.S 20956 6st Main 10nd cross, RaniChennama nagar",15000);
		p3.displayDetails();
		p3.interest(15);
