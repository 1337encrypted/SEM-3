...
class Termwork4{
    public static void main(String[]args){
        FullTimeEmployee ft = new FullTimeEmployee("Yash Herekar","C.T.S 10919 Sadashiv nagar","M",20,50000);
        ft.computeSalary();
        ft.displatDetails();

        PartTimeEmployee pt = new PartTimeEmployee("Vinit Gunaki","Plot No 23 Sahapur","M",19,8,"BE",25);
        pt.computeSalary();
        pt.displatDetails();

        PartTimeEmployee pt1 = new PartTimeEmployee("Piyush Airani","Plot No 35 Rani Chennama nagar","M",19,4,"MTech",25);
        pt1.computeSalary();
        pt1.displatDetails();

        PartTimeEmployee pt2 = new PartTimeEmployee("Nidhi Patil","Plot No 09 Jhadav nagar","F",19,4,"PhD",25);
        pt2.computeSalary();
        pt2.displatDetails();
    }
}
