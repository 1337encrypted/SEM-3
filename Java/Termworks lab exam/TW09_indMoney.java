/*
9). Create a IndMoney class with two integer instance variables rupees and paise. Add a constructor with two parameters for initializing a IndMoney object. The constructor should check the paise value is between 0 and 99 and, if not, transfer some of the paise to the rupees
