/*
11). Design a base class called Employee who work for a Hospital and this class would have name, dob, address, salary and designation as the attributes.
...
class TW11_hospitalEmployee
{
	public static void main(String args[])
	{
		doctor doc1 = new doctor("Anirudh Desai","C.T.S 10919 1st main 2nd cross, Ram nagar.","Senior surgeon",12,9,2001,1500000,"Surgeon",15);
		employee.generateReport(doc1);
		doc1.performDuty();
		
		doctor doc2 = new doctor("Aditya Bagi","C.T.S 20935 5st main 10nd cross, Shastri nagar","Junior surgeon",1,1,2011,100000,"Surgeon",9);
		employee.generateReport(doc2);		
		doc2.performDuty();
		
		doctor doc3 = new doctor("Vinit Nazare","C.T.S 45678 10st main 3nd cross, Shahpur.","Senior orthopedic",15,9,2002,1000000,"Orthopedic",5);
