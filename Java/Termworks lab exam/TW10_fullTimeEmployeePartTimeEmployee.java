...
class TW10_fullTimeEmployeePartTimeEmployee
{
	public static void main(String args[])
	{
		fullTimeEmployee f1 = new fullTimeEmployee("Abhishek Joshi","C.T.S 14919 2st main 21nd cross, sadashiv nagar","Male",20,150000);
		f1.display();
		
		fullTimeEmployee f2 = new fullTimeEmployee("Aditya Vernaker","C.T.S 20457 4st main 7th cross, shau nagar","Male",10,134000);
		f2.display();
		
		partTimeEmployee p1 = new partTimeEmployee("Darshan shanky","C.T.S 34566 12th main 6th cross, ambedkar nagar","Male",20,0,"BE",4,12);
		p1.display();
		
		partTimeEmployee p2 = new partTimeEmployee("Arbaaz Khan","C.T.S 345978 3rd main 8th cross, Azam nagar","Male",20,0,"MTech",3,10);
		p2.display();
		
		partTimeEmployee p3 = new partTimeEmployee("Vinit Joshi","C.T.S 34577 1st main 9th cross, Shahpur","Male",19,0,"Ph.D",2,15);
		p3.display();
